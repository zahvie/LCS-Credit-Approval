...
class ExSTraCS(BaseEstimator, ClassifierMixin):
    ...
    def __init__(self, learning_iterations=100000, N=1000, nu=1, chi=0.8, mu=0.04, theta_GA=25, theta_del=20, theta_sub=20,
        ...
        print("Printing Header -", "IterationNo Accuracy PopulationNumerosity Population Theshold\n")
        self.log_trainingfile.write("IterationNo,Accuracy,PopulationNumerosity,Population,matchSetSize,correctSetSize,macroPopSize,microPopSize,avgIterAge,subsumptionCount,crossOverCount,mutationCount,coveringCount,deletionCount,threshold\n")
